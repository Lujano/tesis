...
Donde $F$ es la distancia focal en milímetros del sensor de la cámara y $W$ y $H$ el ancho y altura del sensor en unidades métricas. Estos valores son proveídos por el fabricante.
